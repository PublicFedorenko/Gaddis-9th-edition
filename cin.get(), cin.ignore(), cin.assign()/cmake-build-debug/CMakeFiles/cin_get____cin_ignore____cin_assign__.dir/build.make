...
CMAKE_SOURCE_DIR = "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()"

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug"
...
CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.o: ../main.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.o"
	/usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.o -c "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/main.cpp"
...
CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.i: cmake_force
	...
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/main.cpp" > CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.i
...
CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.s: cmake_force
	...
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/main.cpp" -o CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/main.cpp.s
...
cin_get____cin_ignore____cin_assign__: CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable cin_get____cin_ignore____cin_assign__"
...
CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/depend:
	cd "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug" && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()" "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()" "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug" "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug" "/home/bohdan/progbase/Gaddis-9th-edition/cin.get(), cin.ignore(), cin.assign()/cmake-build-debug/CMakeFiles/cin_get____cin_ignore____cin_assign__.dir/DependInfo.cmake" --color=$(COLOR)
